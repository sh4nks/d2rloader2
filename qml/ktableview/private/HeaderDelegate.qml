...
QQC2.Control {
    ...
    background: Rectangle {
        readonly property bool containsDrag: delegate.enabled && delegate.headerComponent.draggable && dropArea.containsDrag && dropArea.drag.source.index !== delegate.index
